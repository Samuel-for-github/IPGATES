import { Alert, Button, TouchableOpacity, Pressable, ScrollView, StyleSheet, Text, View } from 'react-native'
            ...
            {courses.map((value, i) => {
              return (
                ...
                <TouchableOpacity key={i} style={styles.cards}
                  onPress={() => {
                    router.push(`/attendance/attendances?folder=${encodeURIComponent(value.title)}`)
                  }}
                >
