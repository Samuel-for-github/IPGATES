    ...
    const fetchStudents = async () => {
        ...
        try {
            ...
            for (const val of data) {
                ...
                const { data: studentData, error: studentError } = await supabase.from('users').select().match({id: val.student_id, role: 'Student'});
        ...
        <ScreenWrapper bg="#b7e4c7">
            ...
            <View style={styles.container}>
                ...
                <Calendar
                    ...
                    theme={{
                        calendarBackground: theme.colors.primaryDark,
                        dayTextColor: 'white',
