import { RefreshControl, Image, Pressable,  FlatList, StyleSheet, Text, TouchableOpacity, View } from 'react-native'
    ...
    const fetchCourseData = async () => {
        ...
        try {
            ...
            const courseData = await Promise.all(res.data.map(async (val, i) => {
                ...
                return {
                    ...val,
                    studentName: studentData ? studentData[0]?.name : 'Unknown', // Assuming student data is an array
                };
            }));
